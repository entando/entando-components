...
<fieldset>
	...
	<p>
        <s:set var="jps3awsclient_paramName" value="'jps3awsclient_S3_active'" />
	...
	<p>
        <s:set var="jps3awsclient_paramName" value="'jps3awsclient_S3_accessKey'" />
	...
	<p>
        <s:set var="jps3awsclient_paramName" value="'jps3awsclient_S3_secretKey'" />
	...
	<p>
        <s:set var="jps3awsclient_paramName" value="'jps3awsclient_S3_bucketName'" />
