    ...
    <s:form action="search" cssClass="form-horizontal">
        <div class="searchPanel form-group">
            <div class="well col-md-offset-3 col-md-6">
                ...
                <div class="col-sm-12">
                    <wpsf:submit value="%{getText('label.search')}" cssClass="btn btn-primary pull-right"  type="button" action="search" >
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <s:if test="#userProfilePrototype.mailAttributeName != null"><th><s:text name="jpaddressbook.label.mailAttribute" /></th></s:if>
                                    <th scope="col">
                                        <abbr title="<s:text name="jpaddressbook.label.ownerAttributeFull" />">
                                        <s:text name="jpaddressbook.label.ownerAttributeShort" />
                                    </abbr>
                                </th>
                                <%--
                                                    ...
                                                    <li>
                                                        ...
                                                        <a
                                                            ...
                                                            href="<s:url action="downloadvcard" namespace="/do/jpaddressbook/VCard"><s:param name="entityId" value="#contactId"></s:param></s:url>" tabindex="<wpsa:counter />"
                                                                    >
                                                                    <span class="icon fa fa-download fa-fw"/>
                                                                    Download VCard
                                                                    <span class="sr-only">&#32;
