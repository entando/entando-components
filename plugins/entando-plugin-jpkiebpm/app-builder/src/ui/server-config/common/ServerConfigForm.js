...
export class ServerConfigFormBody extends Component {
  ...
  render() {
    const {
      handleSubmit, onSubmit, invalid, submitting, testConnection, onAlertDismiss,
    ...
    return (
      <form onSubmit={handleSubmit(onSubmit.bind(this))} className="ServerConfigForm form-horizontal">
        <Row>
          <Col xs={12}>
            {alert}
          </Col>
