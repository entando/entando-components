...
class BpmDatatableTaskListForm extends Component {
  componentWillMount() {
  ...
  render() {
    ...
    return (
      <form
        className="BpmDatatableTaskListForm"
...
BpmDatatableTaskListForm.propTypes = {
...
BpmDatatableTaskListForm.defaultProps = {
  knowledgeSources: [],
  processList: [],
  overrides: null,
  formOverrides: [],
...
export default BpmDatatableTaskListForm;
