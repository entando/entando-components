...
<script
	src="<wp:resourceURL />plugins/jpkiebpm/administration/js/jbpm-process-instance-selector-config.js"></script>
...
<div class="mb-20">
	...
	<s:form action="save"
		namespace="/do/bpm/Page/SpecialWidget/BpmProcessInstanceSelectorViewer"
		class="form-horizontal"  ng-app="bpm-process-instance-selector-config" ng-controller="ProcessConfigEntandoController as vm">
		<p class="noscreen">
