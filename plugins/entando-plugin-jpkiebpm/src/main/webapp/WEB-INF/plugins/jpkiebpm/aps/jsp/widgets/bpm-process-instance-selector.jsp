...
<c:if test="${empty requestScope['bpmSharedDataService']}">
	<script src="<wp:resourceURL />plugins/jpkiebpm/static/js/jbpm-widget-shared-data.js"></script>
	<c:set var="bpmSharedDataService" value="true" scope="request" />
</c:if>
...
<c:if test="${empty requestScope['bpmProcessInstanceSelector']}">
	<script src="<wp:resourceURL />plugins/jpkiebpm/static/js/jbpm-process-instance-selector-component.js"></script>
	<c:set var="bpmProcessInstanceSelector" value="true" scope="request" />
</c:if>

<div id="<%=cId%>" ng-controller="ProcessEntandoController as vm">

<process-instance-selector options="vm.config"></process-instance-selector>
...
<script type="text/javascript">
        (function () {
            ...
            bootProcessInstanceSelectorComponent('<%=cId%>','<wp:resourceURL />',savedConfig);
