 ...
 *
 */
public class BpmProcessDatatableWidgetAction extends BpmFormWidgetAction {

    private static final Logger _logger = LoggerFactory.getLogger(BpmProcessDatatableWidgetAction.class);
