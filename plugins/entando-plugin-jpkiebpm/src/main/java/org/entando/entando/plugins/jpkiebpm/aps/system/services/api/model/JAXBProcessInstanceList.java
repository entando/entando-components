...
public class JAXBProcessInstanceList {

    public JAXBProcessInstanceList() {
    }

    public JAXBProcessInstanceList(String owner, List<JAXBProcessInstance> list) {
        this.setOwner(owner);
        this.setList(list);
    }
    ...
    public List<JAXBProcessInstance> getList() {
        return _list;
    }

    public void setList(List<JAXBProcessInstance> _list) {
        this._list = _list;
    }
    ...
    private List<JAXBProcessInstance> _list;
