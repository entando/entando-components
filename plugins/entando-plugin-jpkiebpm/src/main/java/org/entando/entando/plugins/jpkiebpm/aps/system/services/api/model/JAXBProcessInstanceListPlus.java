...
public class JAXBProcessInstanceListPlus {

    public JAXBProcessInstanceListPlus() {
    }

    public JAXBProcessInstanceListPlus(String owner, List<JAXBProcessInstancePlus> list) {
        this.setOwner(owner);
        this.setList(list);
    }
    ...
    public List<JAXBProcessInstancePlus> getList() {
        return _list;
    }

    public void setList(List<JAXBProcessInstancePlus> _list) {
        this._list = _list;
    }
    ...
    private List<JAXBProcessInstancePlus> _list;
