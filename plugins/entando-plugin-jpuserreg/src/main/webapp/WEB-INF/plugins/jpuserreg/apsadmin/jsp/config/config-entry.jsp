    ...
    <div>
        ...
        <span class="pull-right">
            <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-html="true" title=""
               data-content="<s:text name="jpuserreg.menu.userregAdmin.help"/>" data-placement="left" data-original-title="">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <s:if test="null != #groupVar">
                                                                        <s:property value="#groupVar.description" />&#32;<s:property value="#groupVar.name" />
                                                                    </s:if>
                                                                    <s:else>&ndash;</s:else>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <s:if test="null != #roleVar">
                                                                        <s:property value="#roleVar.description" />&#32;<s:property value="#roleVar.name" />
                                                                    </s:if>
                                                                    <s:else>&ndash;</s:else>
                                                                    </td>
                                ...
                                <s:iterator var="langVar" value="langs">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"
                                            ...
                                            <code class="label label-info"><s:property value="#langVar.code"/>&#32;
