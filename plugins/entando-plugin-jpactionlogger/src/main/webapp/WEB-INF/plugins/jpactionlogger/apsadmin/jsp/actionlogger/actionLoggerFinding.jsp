...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
	<li class="page-title-container"><s:text
			name="title.actionLogger.management" /></li>
</ol>
<h1 class="page-title-container">
	<s:text name="title.actionLogger.management" />
	<span class="pull-right"> <a tabindex="0" role="button"
		data-toggle="popover" data-trigger="focus" data-html="true" title=""
		data-content="<s:text name="title.actionLogger.management.help" />"
...
<div id="main">
		...
		<div class="searchPanel form-group">
			<div class="well col-md-offset-3 col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<wpsf:textfield useTabindexAutoIncrement="true"
							cssClass="form-control input-lg datepicker"
							id="jpactionlogger_dateStart_cal" name="start"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<wpsf:textfield useTabindexAutoIncrement="true"
							cssClass="form-control input-lg datepicker"
							id="jpactionlogger_dateEnd_cal" name="end"
							placeholder="dd/MM/yyyy" />
					</div>
				</div>
				<br> <br>
							...
							<div class="panel-body">
								<div class="form-group">
									<label for="jpactionlogger_username"
										class="control-label col-sm-2"><s:text name="username" /></label>
									<div class="col-sm-9">
										<wpsf:textfield useTabindexAutoIncrement="true"
											cssClass="form-control input-lg" id="jpactionlogger_username"
											name="username" />
									</div>
								</div>
								<div class="form-group">
									<label for="jpactionlogger_namespace"
										class="control-label col-sm-2"><s:text
											name="namespace" /></label>
									<div class="col-sm-9">
										<wpsf:textfield useTabindexAutoIncrement="true"
											cssClass="form-control input-lg"
											id="jpactionlogger_namespace" name="namespace" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<wpsf:textfield useTabindexAutoIncrement="true"
											cssClass="form-control input-lg"
											id="jpactionlogger_actionName" name="actionName" />
									</div>
								</div>
								<div class="form-group">
									<label for="jpactionlogger_params"
										class="control-label col-sm-2"><s:text name="params" /></label>
									<div class="col-sm-9">
										<wpsf:textfield useTabindexAutoIncrement="true"
											cssClass="form-control input-lg" id="jpactionlogger_params"
											name="params" />
									</div>
								</div>
							</div>
	...
	<s:form action="search">
		...
		<wpsa:subset source="actionRecords" count="10"
			objectName="groupActions" advanced="true" offset="5">
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover no-mb">
					...
					<thead>
						<tr>
							<th class="text-center"><s:text name="actiondate" /></th>
							<th class="text-center"><s:text name="username" /></th>
							<th class="text-center"><s:text name="namespace" />/<s:text
									name="actionName" /></th>
							<th><s:text name="params" /></th>
					...
					<tbody>
						<s:iterator var="id">
							...
							<tr>
								<td class="text-center"><s:set var="logRecord"
										value="%{getActionRecord(#id)}" /> <code>
										<s:date name="#logRecord.actionDate" format="dd/MM/yyyy" />
									</code><br /> <code>
										<s:date name="#logRecord.actionDate" format="HH:mm:ss" />
									</code></td>
								<td class="monospace text-center"><s:property
										value="#logRecord.username" /></td>
								<td class="text-center"><s:property
										value="#logRecord.namespace" />/<s:property
										value="#logRecord.actionName" /></td>
								<td><s:set var="recordParametersStringVar"
										...
										<c:otherwise>
											...
											<c:if test="${fn:length(recordParametersArrayVar) > 3}">
												<div id="parameter-item-<c:out value="${logRecord.id}"/>"
													class="collapse">
													<c:forEach items="${recordParametersArrayVar}"
												...
												<a class="cursor-pointer" data-toggle="collapse"
													data-target="#parameter-item-<c:out value='${logRecord.id}'/>"
													title="All parameters"> &hellip; </a>
											</c:if>
										</c:otherwise>
									</c:choose></td>
								<td class="monospace text-center">
									<div class="btn-group btn-group-xs">
										<a
											href="<s:url action="delete"> ><s:param name="id" value="#logRecord.id"></s:param></s:url>"
											title="<s:text name="label.remove" />: <s:date name="#logRecord.actionDate" format="dd/MM/yyyy HH:mm:ss" />"><span
											class="fa fa-trash-o fa-lg"></span>&#32; <span
											class="sr-only"><s:text name="label.alt.clear" /></span> </a>
									</div>
								</td>
							</tr>
						</s:iterator>
