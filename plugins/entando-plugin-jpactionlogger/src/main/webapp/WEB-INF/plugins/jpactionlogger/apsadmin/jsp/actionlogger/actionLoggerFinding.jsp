			...
			<div class="table-responsive">
				...
				<table class="table table-bordered" >
					...
					<tr>
						...
						<th scope="col"><s:text name="namespace" />/<s:text name="actionName" /></th>
					...
					<s:iterator var="id">
						...
						<tr>
							...
							<td class="text-center text-nowrap"><s:set var="logRecord"	value="%{getActionRecord(#id)}" />
								<code><s:date name="#logRecord.actionDate" format="dd/MM/yyyy" /></code><br /><code><s:date name="#logRecord.actionDate" format="HH:mm:ss" /></code>
							</td>
							<%-- Username Column --%>
							<td class="monospace"><s:property value="#logRecord.username"/></td>
							<%-- NameSpace Column --%>
							<td><s:property value="#logRecord.namespace"/>/<s:property value="#logRecord.actionName"/></td>
							<%-- Parameters Column --%>
							<td>
