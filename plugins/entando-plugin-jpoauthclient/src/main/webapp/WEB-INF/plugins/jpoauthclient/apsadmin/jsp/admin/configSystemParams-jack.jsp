...
<fieldset>
	...
	<p>
		...
		<s:set var="jpoauthclient_paramName" value="'jpoauthclient_entandoProvider_baseURL'" />
	...
	<p>
		...
		<s:set var="jpoauthclient_paramName" value="'jpoauthclient_consumer_consumerKey'" />
        <wpsf:textfield useTabindexAutoIncrement="true" name="%{#jpoauthclient_paramName}" id="%{#jpoauthclient_paramName}" value="%{systemParams.get(#jpoauthclient_paramName)}" cssClass="text" />
        <wpsf:hidden name="%{#jpoauthclient_paramName + externalParamMarker}" value="true"/>
	</p>
	...
	<p>
		...
		<s:set var="jpoauthclient_paramName" value="'jpoauthclient_consumer_consumerSecret'" />
        <wpsf:textfield useTabindexAutoIncrement="true" name="%{#jpoauthclient_paramName}" id="%{#jpoauthclient_paramName}" value="%{systemParams.get(#jpoauthclient_paramName)}" cssClass="text" />
        <wpsf:hidden name="%{#jpoauthclient_paramName + externalParamMarker}" value="true"/>
	</p>
	...
	<p>
		...
		<s:set var="jpoauthclient_paramName" value="'jpoauthclient_consumer_callbackURL'" />
        <wpsf:textfield useTabindexAutoIncrement="true" name="%{#jpoauthclient_paramName}" id="%{#jpoauthclient_paramName}" value="%{systemParams.get(#jpoauthclient_paramName)}" cssClass="text" />
        <wpsf:hidden name="%{#jpoauthclient_paramName + externalParamMarker}" value="true"/>
	</p>
