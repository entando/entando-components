 ...
 */
package org.entando.entando.plugins.jpoauthclient.aps.oauth.client;
...
import org.entando.entando.plugins.jpoauthclient.aps.oauth.http.HttpClient;
import org.entando.entando.plugins.jpoauthclient.aps.oauth.http.HttpMessage;
import org.entando.entando.plugins.jpoauthclient.aps.oauth.http.HttpMessageDecoder;
...
public class OAuthClient {
    ...
    public OAuthMessage invoke(OAuthAccessor accessor, String httpMethod,
        ...
        return invoke(request, style, true);
    }
     ...
     *             the HTTP response status code was not 200 (OK)
     */
    public OAuthMessage invoke(OAuthMessage request, ParameterStyle style, boolean throwStatusProblem)
            throws IOException, OAuthException {
        OAuthResponseMessage response = this.access(request, style);
        if (throwStatusProblem && (response.getHttpResponse().getStatusCode() / 100) != 2) {
