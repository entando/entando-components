...
<s:if test="!onEditContent">
	...
	<h2><s:text name="title.attachManagement" /></h2>
</s:if>
...
<wp:ifauthorized permission="manageResources">
	<p><a href="<s:url action="new" ><s:param name="resourceTypeCode" >Attach</s:param></s:url>"><s:text name="label.new" />&#32;<s:text name="label.resource" /></a></p>
<s:if test="!onEditContent">
	<p><a href="<s:url action="new" namespace="/do/jpremoteresourceloader/Resource"><s:param name="resourceTypeCode" >Attach</s:param></s:url>"><s:text name="label.new" />&#32;<s:text name="jpremoteresourceloader.label.remote" /></a></p>
</s:if>
<s:else>
	<p><a href="<s:url action="new" namespace="/do/jpremoteresourceloader/Content/Resource"><s:param name="resourceTypeCode" >Attach</s:param></s:url>"><s:text name="label.new" />&#32;<s:text name="jpremoteresourceloader.label.remote" /></a></p>
</s:else>
</wp:ifauthorized>
...
<dt class="options">
		...
		<s:else>	
			<a href="<s:url action="edit" namespace="/do/jacms/Resource"><s:param name="resourceId" value="%{#resourceid}" /></s:url>" ><img src="<wp:resourceURL />administration/img/icons/edit-content.png" alt="<s:text name="label.edit" />" title="<s:text name="label.edit" />" /></a><span class="noscreen">, </span><a href="<s:url action="trash" namespace="/do/jacms/Resource"><s:param name="resourceId" value="%{#resourceid}" /><s:param name="resourceTypeCode" value="%{#resource.type}" /></s:url>" ><img src="<wp:resourceURL />administration/img/icons/delete.png" alt="<s:text name="label.remove" />" title="<s:text name="label.remove" />" /></a>			
		</s:else>
</dt>
<dd>
