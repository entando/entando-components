					...
					<s:iterator var="widgetTypeItemVar" value="widgetTypeItems" status="rowstatus">
						<tr>
							<td class="text-center text-nowrap">
								<wpsa:actionParam action="removeWidget" var="actionName" ><wpsa:actionSubParam name="widgetCode" value="%{#widgetTypeItemVar.key}" /></wpsa:actionParam>
								<wpsf:submit type="button" src="%{#iconImagePath}" action="%{#actionName}" value="%{getText('label.remove')}" title="%{getText('label.remove') + ': ' + #widgetTypeItemVar.value}" cssClass="btn btn-warning btn-xs">
