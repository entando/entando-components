...
<%-- variabile showletId: il prefisso showlet id "__s__" &egrave; referenziato in jpmyportalplus.js --%>
...
&Egrave; presente un contenitore che raccoglie tutto: dragdrop_box.
All'interno vi sono principalmente due aree: editContentBox, content.
"editContentBox" contiene il form di sposta per l'accessibilit&agrave;
"content" contiene il contenuto vero e proprio.

"editContentBox" &egrave; viene aperto e chiuso dal link con classe css "editContent".
"content" &egrave; viene aperto e chiuso dal link con classe css "openClose".

l'area di trascinamento &egrave; individuata dall'elemento avente classe css "dragdrop_draggable_area".
Pu&ograve; essere un qualsiasi elemento ed attiva l'hover del box.


Il css che costruisce la struttura del box della showlet &egrave; /plugins/jpmyportalplus/static/css/jpmyportalplus.css
...
&egrave; libera, ovvero questi elementi possono essere posizionati ovunque in
qualsiasi posizione all'interno del box principale (dragdrop_box)

&Egrave; possibile aggiungere altri "spacer" allo stesso livello del div
con classe "boxspacer" per creare altro spazio oppure per aggiungere
delle immagini di sfondo.

&Egrave; altres&igrave; possibile aggiungere una sorta di testata nel box prima di "editContentBox"
--%>

<%--
//contenitore del box
class="dragdrop_box" : classe css referenziata in jpmyportalplus.js, serve per dichiarare che &egrave; un box che pu&ograve; essere spostato
id="<c:out value="${showletId}" />" : verr&agrave; sostituito con l'identificativo della showlet o della sua attuale posizione

//area di trascinamento
class="dragdrop_draggable_area": classe css referenziata in jpmyportalplus.js, serve per dichiarare qual'&egrave; l'elemento "maniglia" per il trascinamento
...
<div class="widget margin-medium-bottom" id="<c:out value="${showletId}" />"> <%-- contenitore del box | class="dragdrop_box" : classe css referenziata in jpmyportalplus.js, serve per dichiarare che &egrave; un box che pu&ograve; essere spostato | id="<c:out value="${showletId}" />" : identificativo della showlet o della sua attuale posizione --%>
...
<div class="widget-draggable"> <%-- class="dragdrop_draggable_area": classe css referenziata in jpmyportalplus.js, serve per dichiarare qual'&egrave; l'elemento "maniglia" per il trascinamento. --%>
    <h1 class="pull-right">
        <c:choose>
