INSERT INTO sysconfig (version, item, descr, config) VALUES ('test', 'cthread_config', 'Configurazione thread pubblicazione/sospensione automatica', '<contentThreadconfig sitecode="A">
...
<users>
<!-- l attributo username deve contenere lo username dell utente
 l attributo contentType deve contentere la tipologia o le tipologie di contenuto separate da virgola per cui ricevere le notifiche 
