...
<fieldset class="col-xs-12">
	...
	<div class="form-group">
        <s:set var="jpcomponentinstaller_paramName" value="'jpcomponentinstaller_nexus_active'" />
	...
	<div class="form-group">
        <s:set var="jpcomponentinstaller_paramName" value="'jpcomponentinstaller_nexus_url'" />
	...
	<div class="form-group">
        <s:set var="jpcomponentinstaller_paramName" value="'jpcomponentinstaller_nexus_username'" />
	...
	<div class="form-group">
        <s:set var="jpcomponentinstaller_paramName" value="'jpcomponentinstaller_nexus_password'" />
