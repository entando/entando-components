...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		...
		&#32;/&#32;
		<s:text name="jpcomponentinstaller.title.installer.confirmDownload" />
	</span>
</h1>

<s:form action="installIntro" namespace="/do/jpcomponentinstaller/Installer">
	<p class="sr-only">
	...
	<div>
		<p>
			<s:text name="jpcomponentinstaller.note.installer.confirmDownload" />&#32;
