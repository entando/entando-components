...
public class TestResourceAttributeAction extends AbstractBaseTestContentAction {
    ...
    public void testUpdateAttachResource() throws Throwable {
        ...
        try {
            ...
            this.addParameter("Image:en_Image_alt", "Image Alt - en");
            this.addParameter("Image:en_Image_description", "Image Description - en");
            this.addParameter("Image:en_Image_legend", "Image Legend - en");
            this.addParameter("Image:en_Image_title", "Image Title - en");
            this.addParameter("Image:it_Image_alt", "Image Alt - it");
            this.addParameter("Image:it_Image_description", "Image Description - it");
            this.addParameter("Image:it_Image_legend", "Image Legend - it");
            this.addParameter("Image:it_Image_title", "Image Title - it");
            String result = this.executeAction();
            assertEquals(Action.SUCCESS, result);
            ...
            this.addParameter("categoryCode", "general");
            this.addParameter("Image:en_Image_alt", "Image Alt - en");
            this.addParameter("Image:en_Image_description", "");
            this.addParameter("Image:en_Image_legend", "Image Legend modified - en");
            this.addParameter("Image:en_Image_title", "Image Title modified - en");
            this.addParameter("Image:it_Image_alt", "");
            this.addParameter("Image:it_Image_description", "Image Description - it");
            this.addParameter("Image:it_Image_legend", "Image Legend modified - it");
            this.addParameter("Image:it_Image_title", "Image Title - it");
