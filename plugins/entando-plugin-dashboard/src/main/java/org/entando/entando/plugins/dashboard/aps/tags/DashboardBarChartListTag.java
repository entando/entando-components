...
public class DashboardBarChartListTag extends TagSupport {

	private static final Logger _logger =  LoggerFactory.getLogger(DashboardBarChartListTag.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			*/
			List<Integer> list = dashboardBarChartManager.getDashboardBarCharts();
			this.pageContext.setAttribute(this.getVar(), list);
		} catch (Throwable t) {
			_logger.error("Error in doStartTag", t);
			throw new JspException("Error in DashboardBarChartListTag doStartTag", t);
		}
