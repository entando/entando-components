...
public class DashboardPieChartListTag extends TagSupport {

	private static final Logger _logger =  LoggerFactory.getLogger(DashboardPieChartListTag.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			*/
			List<Integer> list = dashboardPieChartManager.getDashboardPieCharts();
			this.pageContext.setAttribute(this.getVar(), list);
		} catch (Throwable t) {
			_logger.error("Error in doStartTag", t);
			throw new JspException("Error in DashboardPieChartListTag doStartTag", t);
		}
