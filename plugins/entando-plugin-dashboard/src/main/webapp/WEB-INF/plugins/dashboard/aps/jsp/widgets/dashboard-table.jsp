...
<script src="https://cdn.datatables.net/buttons/1.5.6/js/dataTables.buttons.min.js" crossorigin=""></script>

<script src="https://cdn.datatables.net/buttons/1.5.6/js/buttons.flash.min.js" crossorigin=""></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js" crossorigin=""></script>

<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/pdfmake.min.js" crossorigin=""></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js" crossorigin=""></script>
<script src="https://cdn.datatables.net/buttons/1.5.6/js/buttons.html5.min.js" crossorigin=""></script>
<script src="https://cdn.datatables.net/buttons/1.5.6/js/buttons.print.min.js" crossorigin=""></script>
