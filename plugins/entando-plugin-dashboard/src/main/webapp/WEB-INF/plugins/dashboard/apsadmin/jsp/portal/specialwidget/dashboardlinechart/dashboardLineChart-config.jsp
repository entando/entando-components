...
<s:form action="saveConfig" namespace="/do/dashboard/DashboardLineChart/Page/SpecialWidget/dashboardDashboardLineChartConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="dashboardLineChartsId" name="id" id="id" cssClass="form-control" />
