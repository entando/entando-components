...
<s:form action="saveConfig" namespace="/do/dashboard/DashboardMap/Page/SpecialWidget/dashboardDashboardMapConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="dashboardMapsId" name="id" id="id" cssClass="form-control" />
