...
<s:form action="saveConfig" namespace="/do/dashboard/DashboardTable/Page/SpecialWidget/dashboardDashboardTableConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="dashboardTablesId" name="id" id="id" cssClass="form-control" />
