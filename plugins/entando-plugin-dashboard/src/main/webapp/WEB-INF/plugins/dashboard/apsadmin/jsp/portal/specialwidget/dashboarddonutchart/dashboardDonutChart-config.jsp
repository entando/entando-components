...
<s:form action="saveConfig" namespace="/do/dashboard/DashboardDonutChart/Page/SpecialWidget/dashboardDashboardDonutChartConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="dashboardDonutChartsId" name="id" id="id" cssClass="form-control" />
