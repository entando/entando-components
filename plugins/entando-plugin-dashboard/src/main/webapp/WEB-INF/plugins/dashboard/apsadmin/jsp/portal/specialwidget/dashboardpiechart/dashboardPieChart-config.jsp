...
<s:form action="saveConfig" namespace="/do/dashboard/DashboardPieChart/Page/SpecialWidget/dashboardDashboardPieChartConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="dashboardPieChartsId" name="id" id="id" cssClass="form-control" />
