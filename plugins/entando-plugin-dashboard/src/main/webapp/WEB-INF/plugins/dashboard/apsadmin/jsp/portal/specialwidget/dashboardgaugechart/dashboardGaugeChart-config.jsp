...
<s:form action="saveConfig" namespace="/do/dashboard/DashboardGaugeChart/Page/SpecialWidget/dashboardDashboardGaugeChartConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="dashboardGaugeChartsId" name="id" id="id" cssClass="form-control" />
