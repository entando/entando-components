...
export const destroy = jest
  .fn()
  .mockReturnValue({ type: '@@redux-form/DeSTROY' });
...
export const startAsyncValidation = jest
  .fn()
  .mockReturnValue({ type: '@@redux-form/START_AV' });
export const startSubmit = jest
  .fn()
  .mockReturnValue({ type: '@@redux-form/START_SUBMIT' });
export const stopSubmit = jest
  .fn()
  .mockReturnValue({ type: '@@redux-form/STOP_SUBMIT' });
export const stopAsyncValidation = jest
  .fn()
  .mockReturnValue({ type: '@@redux-form/STOP_AV' });
export const touch = jest.fn().mockReturnValue({ type: '@@redux-form/TOUCH' });
export const untouch = jest
  .fn()
  .mockReturnValue({ type: '@@redux-form/UNTOUCH' });
export const clearFields = jest
  .fn()
  .mockReturnValue({ type: '@@redux-form/CLEAR_FIELDS' });
...
export const getFormSyncErrors = jest.fn(form => () => ({ form }));
