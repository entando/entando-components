export default {
  ...
  messages: {
    ...
    'plugin.dashboardSetting': 'IoT Setting',
    ...
    'plugin.chooseAnOptionDatasourceType': 'Select Datasource Type',
    ...
    'plugin.config.previewDatasource': 'Preview of columns for Datasource',
    'plugin.config.previewColumn': 'Column name',
