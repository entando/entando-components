...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
	...
	<li class="page-title-container"><s:text
			name="jpcrowdsourcing.title.comments.view" /></li>
</ol>
		...
		<div class="col-sm-6">
			<h1>
				...
				<span class="pull-right"> <a tabindex="0" role="button"
					...
					title=""
					data-content="<s:text name="jpcrowdsourcing.title.comments.view.help" />"
	...
	<s:form action="changeStatus">
				...
				<tr>
					...
					<s:if test="#comment.status == 3">
						...
						<s:set var="isOnlineStatus"
							value="%{getText('jpcrowdsourcing.label.status_approved.singular')}" />
					</s:if>
					...
					<td class="col-sm-10"><span
						title="<s:property value="isOnlineStatus"/>"
						class="<s:property value="iconImage"/>"></span></td>
				</tr>
			</table>
		</div>
		...
		<p class="centerText">
			<a class="<s:property value="btnClass"/>"
				...
				<span class="<s:property value="btnIcon"/>"></span>&#32; <s:property
					value="#label" />
			</a>
		</p>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<table class="table table-bordered">
					<tr>
						<th class="text-right"><s:url action="edit"
								namespace="/do/collaboration/Idea" var="editIdeaActionUrl">
								<s:param name="ideaId" value="#idea.id" />
							</s:url> <a href="<s:property value="#editIdeaActionUrl" />"> <s:property
									value="#idea.title" />
						</a></th>
