...
<h1><wp:i18n key="jpcollaboration_STATISTIC_TITLE" /></h1>
	...
	<c:choose>
		...
		<ul class="unstyled">
			<li class="text-right">
				<wp:i18n key="jpcollaboration_PROPOSED_IDEAS" />&#32;<span class="badge"><c:out value="${stats.ideas}" /></span>
			</li>
			<li class="text-right">
				<wp:i18n key="jpcollaboration_VOTES" />&#32;<span class="badge"><c:out value="${stats.votes}" /></span>
			</li>
			<li class="text-right">
				<wp:i18n key="jpcollaboration_IDEA_COMMENTS" />&#32;<span class="badge"><c:out value="${stats.comments}" /></span>
			</li>
			<li class="text-right">
				<wp:i18n key="jpcollaboration_USERS" />&#32;<span class="badge"><c:out value="${stats.users}" /></span>
			</li>
		</c:when>
		<c:otherwise>
