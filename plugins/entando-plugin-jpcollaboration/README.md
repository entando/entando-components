# entando-plugin-jpcowdsourcing _collaboration plugin_


## What it does

Donec quis dolor urna. Nunc lectus enim, tincidunt a vulputate venenatis, gravida nec elit. Vestibulum at tempor lacus. Quisque nec interdum neque, sed lobortis purus. Vestibulum nibh elit, iaculis a quam eu, molestie lacinia urna. Ut egestas venenatis scelerisque. Phasellus egestas libero in elit gravida lobortis.
...
The page model where `widgets` will be published _must_ contain the following snippet in the `<head>` tag
...
ALTER TABLE jpcrowdsourcing_idea_comments DROP COLUMN nickname;
ALTER TABLE jpcrowdsourcing_idea_comments DROP COLUMN professioneid;
ALTER TABLE jpcrowdsourcing_idea_comments DROP COLUMN datanascita;
ALTER TABLE jpcrowdsourcing_idea_comments RENAME commento TO commenttext;
ALTER TABLE jpcrowdsourcing_idea_comments RENAME TO jpcollaboration_idea_comments;

ALTER TABLE jpcrowdsourcing_idea RENAME TO jpcollaboration_idea;

ALTER TABLE jpcrowdsourcing_idea_tags DROP COLUMN categorytype;
ALTER TABLE jpcrowdsourcing_idea_tags RENAME TO jpcollaboration_idea_tags;

ALTER TABLE jpcrowdsourcing_ideainstance_group RENAME TO jpcollaboration_ideainstance_group;

ALTER TABLE jpcrowdsourcing_ideainstance  RENAME TO jpcollaboration_ideainstance;
...
/*categories */
insert into categories select 'jpcollaboration_categoryRoot', parentcode, titles from categories where catcode = 'jpcrowdsourcing_categoryRoot';
update categories set parentcode = 'jpcollaboration_categoryRoot' where parentcode = 'jpcrowdsourcing_categoryRoot';

/* widgets */

INSERT INTO widgetcatalog select 'jpcollaboration_entryIdea', titles, parameters, 'jpcollaboration', parenttypecode, defaultconfig, locked, maingroup from widgetcatalog where code = 'jpcrowdsourcing_entryIdea';
INSERT INTO widgetcatalog select 'jpcollaboration_fastEntryIdea', titles, parameters, 'jpcollaboration', parenttypecode, defaultconfig, locked, maingroup from widgetcatalog where code = 'jpcrowdsourcing_fastEntryIdea';
INSERT INTO widgetcatalog select 'jpcollaboration_idea', titles, parameters, 'jpcollaboration', parenttypecode, defaultconfig, locked, maingroup from widgetcatalog where code = 'jpcrowdsourcing_idea';
INSERT INTO widgetcatalog select 'jpcollaboration_idea_find', titles, parameters, 'jpcollaboration', parenttypecode, defaultconfig, locked, maingroup from widgetcatalog where code = 'jpcrowdsourcing_idea_find';
INSERT INTO widgetcatalog select 'jpcollaboration_ideaInstance', titles, parameters, 'jpcollaboration', parenttypecode, defaultconfig, locked, maingroup from widgetcatalog where code = 'jpcrowdsourcing_ideaInstance';
INSERT INTO widgetcatalog select 'jpcollaboration_idea_tags', titles, parameters, 'jpcollaboration', parenttypecode, defaultconfig, locked, maingroup from widgetcatalog where code = 'jpcrowdsourcing_idea_tags';
INSERT INTO widgetcatalog select 'jpcollaboration_search_result', titles, parameters, 'jpcollaboration', parenttypecode, defaultconfig, locked, maingroup from widgetcatalog where code = 'jpcrowdsourcing_search_result';
INSERT INTO widgetcatalog select 'jpcollaboration_statistics', titles, parameters, 'jpcollaboration', parenttypecode, defaultconfig, locked, maingroup from widgetcatalog where code = 'jpcrowdsourcing_statistics';

----

UPDATE widgetcatalog SET defaultconfig = regexp_replace("defaultconfig",'jpcrowdsourcing', 'jpcollaboration', 'g') where plugincode ='jpcollaboration' ;
UPDATE widgetcatalog SET titles = regexp_replace("titles",'Crowd Sourcing', 'Collaboration', 'g') where plugincode ='jpcollaboration' ;
----

update widgetconfig set widgetcode='jpcollaboration_entryIdea' where widgetcode = 'jpcrowdsourcing_entryIdea';
update widgetconfig set widgetcode='jpcollaboration_fastEntryIdea' where widgetcode = 'jpcrowdsourcing_fastEntryIdea';
update widgetconfig set widgetcode='jpcollaboration_idea' where widgetcode = 'jpcrowdsourcing_idea';
update widgetconfig set widgetcode='jpcollaboration_idea_find' where widgetcode = 'jpcrowdsourcing_idea_find';
update widgetconfig set widgetcode='jpcollaboration_ideaInstance' where widgetcode = 'jpcrowdsourcing_ideaInstance';
update widgetconfig set widgetcode='jpcollaboration_idea_tags' where widgetcode = 'jpcrowdsourcing_idea_tags';
update widgetconfig set widgetcode='jpcollaboration_search_result' where widgetcode = 'jpcrowdsourcing_search_result';
update widgetconfig set widgetcode='jpcollaboration_statistics' where widgetcode = 'jpcrowdsourcing_statistics';

----

delete from widgetcatalog where code = 'jpcrowdsourcing_entryIdea';
delete from widgetcatalog where code = 'jpcrowdsourcing_fastEntryIdea';
delete from widgetcatalog where code = 'jpcrowdsourcing_idea';
delete from widgetcatalog where code = 'jpcrowdsourcing_idea_find';
delete from widgetcatalog where code = 'jpcrowdsourcing_ideaInstance';
delete from widgetcatalog where code = 'jpcrowdsourcing_idea_tags';
delete from widgetcatalog where code = 'jpcrowdsourcing_search_result';
delete from widgetcatalog where code = 'jpcrowdsourcing_statistics';

/* sysconfig */
UPDATE sysconfig SET item='jpcollaboration_config' WHERE item='jpcrowdsourcing_config';


UPDATE sysconfig SET config = regexp_replace("config",'jpcrowdsourcing', 'jpcollaboration', 'g') where item ='entandoComponentsReport' ;
--UPDATE sysconfig  SET config = regexp_replace("config",'jpcrowdsourcing_', 'jpcollaboration_','g') where item ='entandoComponentsReport' ;
