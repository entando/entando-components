    ...
    <s:form namespace="/do/jpphotogallery/Page/SpecialWidget/Photogallery" cssClass="form-horizontal">
        <div class="panel panel-default">
                ...
                <s:if test="filterTypeId < 0">
                    ...
                    <fieldset class="margin-base-top">
                        ...
                        <p>
                            ...
                            <wpsf:select name="filterKey" id="filterKey" list="filterTypes" listKey="key"
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <wpsf:select id="filterOptionId" name="filterOptionId"
                                                 list="#{3:getText('label.presenceOptionFilter'),4:getText('label.absenceOptionFilter'),1:getText('label.valueLikeOptionFilter'),2:getText('label.rangeOptionFilter')}"
                                                 disabled="filterOptionId>-1" cssClass="form-control"/>
                                    <s:if test="filterOptionId>-1"><wpsf:hidden name="filterOptionId"/></s:if>
                                    <s:else>
                                    <div class="input-group-btn">
                                        <wpsf:submit action="setFilterOption" value="%{getText('label.continue')}"
				...
				<div class="col-xs-10">
					<div class="input-group">
						<%--<s:if test="filterOptionId<=-1">--%>
							<%--<div class="input-group">--%>
						<%--</s:if>--%>
						<wpsf:select name="filterOptionId" id="filterOptionId"
                                     list="#{3:getText('label.presenceOptionFilter'),4:getText('label.absenceOptionFilter'),1:getText('label.valueOptionFilter'),2:getText('label.rangeOptionFilter')}"
                                     disabled="filterOptionId>-1" cssClass="form-control"/>
						<s:if test="filterOptionId>-1"><wpsf:hidden name="filterOptionId"/></s:if>
						<s:else>
							<div class="input-group-btn">
			...
			<ul class="list-unstyled">
				<li class="radio">
					<label><input type="radio" name="booleanValue" id="booleanValue_true" value="true"/>&#32;<s:text
                            name="label.yes"/></label>
				</li>
				<li class="radio">
					<label><input type="radio" name="booleanValue" id="booleanValue_false" value="false"/>&#32;<s:text
                            name="label.no"/></label>
				</li>
				<li class="radio">
					<label><input type="radio" name="booleanValue" id="booleanValue_none" checked="checked"
                                  value=""/><s:text name="label.all"/></label>
				</li>
			</ul>
			</fieldset>
			<%-- // Boolean --%>
					...
					<li class="form-inline margin-base-vertical">
						<div class="radio-inline">
							<label>
								<input type="radio" name="dateValueType" id="dateValueType_today" value="2"
                                       <s:if test="(2 == dateValueType)">checked="checked"</s:if> />&#32;<s:text
                                    name="label.today"/>
							</label>
						</div>
						<div class="form-group margin-small-left">
							...
							<wpsf:textfield name="valueDateDelay" id="valueDateDelay" cssClass="form-control"
                                            style="width: 60%;" placeholder="%{getText('label.delay')}"/>
						</div>
					</li>
					<li class="form-inline margin-base-vertical">
						<div class="radio-inline">
							<label>
								<input type="radio" name="dateValueType" id="dateValueType_chosen" value="3"
                                       <s:if test="(3 == dateValueType)">checked="checked"</s:if> />&#32;<s:text
                                    name="label.chosenDate"/>,
							</label>
						</div>
						<div class="form-group margin-small-left">
							...
							<wpsf:textfield name="dateValue" id="dateValue_cal" cssClass="form-control datepicker"
                                            style="width: 60%;" placeholder="dd/MM/yyyy"/>
						</div>
					</li>
				</ul>
                </s:if>
			...
			<ul class="list-unstyled">
				<li class="form-inline margin-base-vertical">
					<div class="radio-inline">
						<label>
							<input type="radio" name="dateStartType" id="dateStartType_none" value="1"
                                   <s:if test="(1 == dateStartType)">checked="checked"</s:if> />&#32;<s:text
                                name="label.none"/>
						</label>
					</div>
				</li>
				<li class="form-inline margin-base-vertical">
					<div class="radio-inline">
						<label>
							<input type="radio" name="dateStartType" id="dateStartType_today" value="2"
                                   <s:if test="(2 == dateStartType)">checked="checked"</s:if> />&#32;<s:text
                                name="label.today"/>
						</label>
					</div>
					<div class="form-group margin-small-left">
						<label for="startDateDelay" class="sr-only"><s:text name="label.delay"/></label>
						<wpsf:textfield name="startDateDelay" id="startDateDelay" cssClass="form-control"
                                        style="width: 60%;" placeholder="%{getText('label.delay')}"/>
					</div>
				</li>
				<li class="form-inline margin-base-vertical">
					<div class="radio-inline">
						<label>
							<input type="radio" name="dateStartType" id="dateStartType_chosen" value="3"
                                   <s:if test="(3 == dateStartType)">checked="checked"</s:if> />&#32;<s:text
                                name="label.chosenDate"/>,
						</label>
					</div>
					<div class="form-group margin-small-left">
						<label for="dateStart_cal"><s:text name="label.filterValue.exact"/></label>
						<wpsf:textfield name="dateStart" id="dateStart_cal" cssClass="form-control datepicker"
                                        style="width: 60%;" placeholder="dd/MM/yyyy"/>
					</div>
				</li>
			</ul>
			...
			<ul class="list-unstyled">
				<li class="form-inline margin-base-vertical">
					<div class="radio-inline">
						<label>
							<input type="radio" name="dateEndType" id="dateEndType_none" value="1"
                                   <s:if test="(1 == dateEndType)">checked="checked"</s:if> />&#32;<s:text
                                name="label.none"/>
						</label>
					</div>
				</li>
				<li class="form-inline margin-base-vertical">
					<div class="radio-inline">
						<label>
							<input type="radio" name="dateEndType" id="dateEndType_today" value="2"
                                   <s:if test="(2 == dateEndType)">checked="checked"</s:if> />&#32;<s:text
                                name="label.today"/>
						</label>
					</div>
					<div class="form-group margin-small-left">
						<label for="endDateDelay" class="sr-only"><s:text name="label.delay"/></label>
						<wpsf:textfield name="endDateDelay" id="endDateDelay" cssClass="form-control" style="width: 60%"
					...
					<div class="radio-inline">
						<label>
							<input type="radio" name="dateEndType" id="dateEndType_chosen" value="3"
                                   <s:if test="(3 == dateEndType)">checked="checked"</s:if> /><s:text
                                name="label.chosenDate"/>,
						</label>
					</div>
					<div class="form-group margin-small-left">
						<label for="dateEnd_cal"><s:text name="label.filterValue.exact"/>:</label>
						<wpsf:textfield name="dateEnd" id="dateEnd_cal" cssClass="form-control datepicker"
                                        style="width: 60%;" placeholder="dd/MM/yyyy"/>
					</div>
				</li>
			</ul>
					...
					<div class="btn-group col-sm-5" data-toggle="buttons">
						...
						<label class="btn btn-default">
							<input type="radio" name="order" value="ASC"
                                   <s:if test="('ASC' == order)">checked="checked"</s:if> />&#32;
							<s:text name="label.order.ascendant"/>
						</label>
						<label class="btn btn-default">
							<input type="radio" name="order" value="DESC"
                                   <s:if test="('DESC' == order)">checked="checked"</s:if> />&#32;<s:text
                                name="label.order.descendant"/>
						</label>
					</div>
				</div>
			</fieldset>
