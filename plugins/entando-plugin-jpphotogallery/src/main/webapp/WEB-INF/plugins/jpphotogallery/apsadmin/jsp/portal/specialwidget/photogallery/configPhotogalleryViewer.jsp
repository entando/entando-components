                ...
                <s:else>
                    ...
                    <fieldset class="form-horizontal">
                        ...
                        <div class="collapse" id="options-publishing">
                            ...
                            <div class="form-group">
                                <label class="col-xs-2 control-label" for="modelIdPreview"><s:text
                                        name="label.contentModelPreview"/></label>
                                <div class="col-xs-10">
                            ...
                            <div class="form-group">
                                <label class="col-xs-2 control-label" for="maxElements"><s:text
                                        name="label.maxElements"/></label>
                                <div class="col-xs-10">
                    ...
                    <fieldset class="form-horizontal">
                        ...
                        <div class="collapse" id="filters">
                            <div class="form-group">
                                <label class="col-xs-2 control-label" for="category"><s:text
                                        name="label.categories"/></label>
                                <div class="col-xs-10">
                                    <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <s:if test="null != categoryCodes && categoryCodes.size() > 0">
                                            ...
                                            <s:iterator value="categoryCodes" var="categoryCodeVar">
                                                <s:set var="showletCategory"
                                                       value="%{getCategory(#categoryCodeVar)}"></s:set>
                            ...
                            <div class="form-group">
                                <label class="col-xs-2 control-label" for="filterKey"><s:text
                                        name="label.filter"/></label>
                                <div class="col-xs-10">
                                    <div class="input-group">
                                                    ...
                                                    <s:if test="(#filter['start'] != null) || (#filter['end'] != null) || (#filter['value'] != null)">,
                                                        <s:if test="#filter['start'] != null">
                                                            ...
                                                            <s:if test="#filter['startDateDelay'] != null">
                                                                <s:text name="label.filterValueDateDelay"/>:<strong>
                                                                <s:property
                    ...
                    <fieldset class="form-horizontal">
                        ...
                        <div class="collapse" id="options-extra">
                            ...
                            <s:iterator var="lang" value="langs">
                                <div class="form-group">
                                    <label class="col-xs-2 control-label"
                                           for="linkDescr_<s:property value="#lang.code" />">
                                        <code class="label label-info"><s:property value="#lang.code"/></code>&#32;
                    ...
                    <fieldset class="form-horizontal">
                        ...
                        <div class="collapse" id="filters-frontend">
                            <div class="form-group">
                                <label class="col-xs-2 control-label" for="userFilterKey"><s:text
                                        name="label.filter"/></label>
                                <div class="col-xs-10">
                                    <div class="input-group">
                            ...
                            <s:if test="null != userFiltersProperties && userFiltersProperties.size() > 0">
                                <div class="row">
                                    <div class="col-xs-10 col-xs-offset-2">
                                        <ol class="list-group">
                                            <s:iterator value="userFiltersProperties" var="userFilter"
                                                        status="rowstatus">
                                                <li class="list-group-item">
                                                    <s:text name="label.filterBy"/>
                                                    <strong>
                                                        <s:if test="#userFilter['attributeFilter'] == 'false'">
                                                            ...
                                                            <s:elseif test="#userFilter['key'] == 'category'">
                                                                ...
                                                                <s:if test="null != #userFilter['categoryCode']">
                                                                    ...
                                                                    (<s:property
                                                                        value="#userFilterCategoryRoot.getFullTitle(currentLang.code)"/>)
                                                                </s:if>
                                                            </s:elseif>
                                                        </s:if>
                                                    ...
                                                    <div class="btn-toolbar pull-right">
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <wpsa:actionParam action="removeUserFilter"
                                                                              var="actionName">
                                                                <wpsa:actionSubParam name="filterIndex"
                                                                                     value="%{#rowstatus.index}"/>
                                                            </wpsa:actionParam>
