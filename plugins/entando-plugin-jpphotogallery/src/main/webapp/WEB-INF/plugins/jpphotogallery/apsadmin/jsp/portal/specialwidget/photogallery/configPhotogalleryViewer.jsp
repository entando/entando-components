...
<s:form action="saveConfig" namespace="/do/jpphotogallery/Page/SpecialWidget/Photogallery" cssClass="form-horizontal">
			...
			<div class="col-xs-12">
				...
				<div class="input-group">
					...
					<span class="input-group-btn">
						<wpsf:submit type="button" action="configWidget" cssClass="btn btn-success">
			...
			<div class="collapse" id="options-publishing">
				...
				<div class="form-group">
					<div class="col-xs-12">
						...
						<wpsf:select name="modelIdMaster" id="modelIdMaster" value="%{getShowlet().getConfig().get('modelIdMaster')}" 
				...
				<div class="form-group">
					<div class="col-xs-12">
						...
						<wpsf:select name="modelIdPreview" id="modelIdPreview" value="%{getShowlet().getConfig().get('modelIdPreview')}" 
							list="%{getModelsForContentType(showlet.config['contentType'])}" headerKey="" headerValue="%{getText('label.default')}" listKey="id" listValue="description" cssClass="form-control" />
					</div>
				</div>
