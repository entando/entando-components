...
public class IotConfigListTag extends TagSupport {

	private static final Logger _logger =  LoggerFactory.getLogger(IotConfigListTag.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			*/
			List<Integer> list = iotConfigManager.getIotConfigs();
			this.pageContext.setAttribute(this.getVar(), list);
		} catch (Throwable t) {
			_logger.error("Error in doStartTag", t);
			throw new JspException("Error in IotConfigListTag doStartTag", t);
		}
