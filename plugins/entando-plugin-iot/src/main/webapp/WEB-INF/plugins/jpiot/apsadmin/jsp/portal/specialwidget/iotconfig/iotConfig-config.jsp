...
<s:form action="saveConfig" namespace="/do/jpiot/IotConfig/Page/SpecialWidget/jpiotIotConfigConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="iotConfigsId" name="id" id="id" cssClass="form-control" />
