...
<s:form action="saveConfig" namespace="/do/jpiot/IotListDevices/Page/SpecialWidget/jpiotIotListDevicesConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="iotListDevicessId" name="id" id="id" cssClass="form-control" />
