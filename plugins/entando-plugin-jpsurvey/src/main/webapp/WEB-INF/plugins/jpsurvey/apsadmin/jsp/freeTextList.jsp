...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
	...
	<li class="page-title-container"><s:text
			name="jpsurvey_freeText_results" /></li>
</ol>
		...
		<div class="col-sm-6">
			<h1>
				...
				<span class="pull-right"> <a tabindex="0" role="button"
					...
					title=""
					data-content="<s:text name="jpsurvey_freeText_results.help" />"
		...
		<table class="table table-bordered table-hover no-mb">
			<tr>
				<th class="text-right col-sm-2"><s:text
						name="jpsurvey_freeText_answers" /></th>
				<th class="text-right col-sm-2"><s:text
						name="jpsurvey_freeText_occurences" /></th>
			</tr>
			<s:iterator var="currentFreeText" value="freeTextMap">
				<tr>
					...
					<td class="col-sm-10"><s:property
							value="#currentFreeText.value" /></td>
				</tr>
			</s:iterator>
		</table>
	</s:if>
