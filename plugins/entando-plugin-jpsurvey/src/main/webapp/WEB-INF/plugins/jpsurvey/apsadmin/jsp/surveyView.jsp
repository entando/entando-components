...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
    ...
    <li><s:text name="title.surveyList" /></li>
        ...
        <li>
            <a href="<s:url action="listSurveys" ><s:param name="questionnaire" value="questionnaire"></s:param></s:url>"
        ...
        <div class="col-sm-6">
            <h1>
                ...
                <span class="pull-right"> 
                    <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-content="<s:text name="title.jpsurvey.survey.results.help" />" data-placement="left" data-original-title="">
    ...
    <div class="col-xs-12">
        <table class="table table-bordered table-hover no-mb">
            ...
            <tr>
                ...
                <td class="col-sm-10">
                    <s:property value="%{getLabel(survey.descriptions)}" />
                </td>
            </tr>
            <tr>
                <th class="text-right col-sm-2">
                    <s:text name="jpsurvey_voters" />
                </th>
                <td class="col-sm-10">
                    <s:property value="%{totalVoters}" />
                </td>
            </tr>
        </table>
                        ...
                        <li>
                            <s:if test="#choice.freeText">
                                ...
                                <s:if test="%{#occurrence != null && #occurrence != ''}">
                                    <a href="<s:url action="freeTextListEntry"><s:param name="choiceId" value="#choice.id"/><s:param name="questionId" value="%{#question.id}"/><s:param name="surveyId" value="%{survey.id}"/><s:param name="questionnaire" value="questionnaire"/><s:param name="strutsAction" value="2"/></s:url>"
                                       title="<s:text name="label.view.freeText" />"> 
                    ...
                    <dl class="graph">
                        <s:iterator var="choice" value="#question.choices"
                            ...
                            <s:else>
                                <dt>
                                <span class="noscreen">
                                    <s:text  name="jpsurvey.answer.number" />
                                </span>&#32;
                                <em class="leftEm">
                                    <s:property  value="#rowstatus.index + 1" />
                                </em>&#32;
                                <span class="noscreen">
                                    <s:text name="jpsurvey.obtained" />
                                </span>&#32;
                                </dt>
                            </s:else>
                            <s:set var="occurrence" value="#occurrences[#choice.id]" />
                            ...
                            <dd>
                                <span style="color:#FFF;" class="p<s:text name="format.roundedPercentage"><s:param name="value" value="#roundedPercentage"/></s:text>">
