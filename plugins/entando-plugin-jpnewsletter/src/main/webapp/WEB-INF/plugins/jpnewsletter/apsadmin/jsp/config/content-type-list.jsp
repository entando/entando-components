...
<s:form action="addContentTypeConfig">
	...
	<fieldset class="margin-large-top form-horizontal">
        ...
        <div class="alert alert-info">
          ...
          <s:text name="jpnewsletter.contenttypeConfig.intro" />: <strong><s:property value="getSmallContentType(contentTypeCode).descr" /></strong>.
        </div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<wpsf:select id="jpnewsletter_text_model" name="newsletterContentType.simpleTextModel" list="getContentModelByType(newsletterContentType.contentTypeCode)" listKey="id" headerKey="" headerValue="%{getText('note.choose')}" listValue="description" cssClass="form-control" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<wpsf:select id="jpnewsletter_html_model" name="newsletterContentType.htmlModel" list="getContentModelByType(newsletterContentType.contentTypeCode)" headerKey="" headerValue="%{getText('note.choose')}" listKey="id" listValue="description" cssClass="form-control" />
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-12">
