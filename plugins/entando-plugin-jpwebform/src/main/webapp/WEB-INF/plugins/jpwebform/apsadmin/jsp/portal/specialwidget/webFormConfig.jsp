            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="jpwebform_typecode"><s:text name="label.typeCode"/></label>
                        <wpsf:select id="jpwebform_typecode" name="typeCode" list="messageTypes" listKey="code" listValue="descr" cssClass="form-control"/>
                    </div>
