    ...
    <s:form action="search" cssClass="form-horizontal">
        ...
        <div class="form-group">
            <div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <%--<label for="jpwebform_MSG_TYPE" class=" label-search"><s:text name="label.search.message.type" />:</label>--%>
                <s:set var="disabledSelectTypeVar" value="%{!(null == entityTypeCode || entityTypeCode == '')}" />
                <wpsf:select name="entityTypeCode" id="entityTypeCode" list="entityPrototypes" listKey="typeCode" listValue="typeDescr" headerKey="" headerValue="%{getText('label.all')}" cssClass="form-control input-lg" disabled="%{#disabledSelectTypeVar}" />
                <span class="input-group-btn">
                    <s:if test="#disabledSelectTypeVar">
        ...
        <div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div id="search-advanced" class="collapse well collapse-input-group">
                <div class="form-group">
                    <label for="jpwebform_from_cal" class="control-label col-sm-2 text-right"><s:text name="label.from"/></label>
                    <div class="col-sm-5">
                        <wpsf:textfield name="from" id="jpwebform_from_cal" cssClass="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="jpwebform_to_cal" class="control-label col-sm-2 text-right"><s:text name="label.to"/></label>
                    <div class="col-sm-5">
                        <wpsf:textfield name="to" id="jpwebform_to_cal" cssClass="form-control" />
                    </div>
                </div>

                <div class="form-group">
                    <label for="jpwebform_status" class="control-label col-sm-2 text-right"><s:text name="label.status"/></label>
                    <div class="col-sm-5">
                        <select name="answered" id="jpwebform_status" class="form-control">
                    ...
                    <s:iterator var="attribute" value="#searcheableAttributes">
                        ...
                        <s:elseif test="#attribute.type == 'Date'">
                            ...
                            <s:set var="dateEndInputFieldName" ><s:property value="#attribute.name" />_dateEndFieldName</s:set>
                                ...
                                <div class="col-sm-5">
                                    <wpsf:textfield id="%{#currentFieldId+'_start_cal'}" cssClass="form-control datepicker" name="%{#dateStartInputFieldName}" value="%{getSearchFormFieldValue(#dateStartInputFieldName)}" />
                                    <span class="help-block">dd/MM/yyyy</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2 text-right" for="<s:property value="#currentFieldId" />_end_cal"><s:property value="#attribute.name" />&#32;<s:text name="label.search.value.end" /></label>
                                <div class="col-sm-5">
                        ...
                        <s:elseif test="#attribute.type == 'Number'">
                            ...
                            <s:set var="numberEndInputFieldName" ><s:property value="#attribute.name" />_numberEndFieldName</s:set>
                                ...
                                <div class="col-sm-5">
                                    <wpsf:textfield id="%{#currentFieldId}_start" cssClass="text" name="%{#numberStartInputFieldName}" value="%{getSearchFormFieldValue(#numberStartInputFieldName)}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2 text-right" for="<s:property value="#currentFieldId" />_end"><s:property value="#attribute.name" />&#32;<s:text name="label.search.value.end" /></label>
                                <div class="col-sm-5">
                                    <wpsf:textfield id="%{#currentFieldId}_end" cssClass="text" name="%{#numberEndInputFieldName}" value="%{getSearchFormFieldValue(#numberEndInputFieldName)}" />
                                </div>
                            </div>
                        </s:elseif>
                        ...
                        <s:elseif test="#attribute.type == 'Boolean'">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="checkbox">
                                        <wpsf:checkbox name="%{#attribute.name}" id="%{#currentFieldId}" cssClass="radiocheck" />&nbsp;
                                    </div>
                                </div>
                            </div>
                        </s:elseif>
                        ...
                        <s:iterator var="messageId">
                            ...
                            <tr>
                                <td class="text-center">
                                    ...
                                    <a href="<s:url action="newAnswer"><s:param name="id" value="#message.id"/></s:url>" title="<s:text name="label.newAnswer.at" />: <s:property value="#message.id" />"><img src="<wp:resourceURL />plugins/jpwebform/administration/img/icons/mail-reply-sender.png" alt="<s:text name="label.newAnswer" />" /></a>
                                    ...
                                    <a class="btn btn-warning" href="<s:url action="trash">
                                           <s:param name="id" value="#message.id"/>
                                       </s:url>" 
                                ...
                                <td>
                                    <code><s:property value="#message.id"/>&#32;&ndash;&#32;<s:property value="#message.typeDescr"/></code>
                                </td>
