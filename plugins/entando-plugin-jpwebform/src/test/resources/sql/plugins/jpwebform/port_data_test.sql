INSERT INTO sysconfig (version, item, descr, config) VALUES ('test', 'jpwebform_messageNotifierConfig', 
	'Configurazione del servizio di notifica Messaggi', '<messagetypes />');

INSERT INTO sysconfig (version, item, descr, config) VALUES ('test', 'jpwebform_messageTypes', 
	'Definizione dei Tipi di Messaggio', '<?xml version="1.0" encoding="UTF-8"?>
<formtypes>
	<formtype typecode="COM" typedescr="Company Form" version="1" repeatable="true">
		<attributes>
	...
	<formtype typecode="PER" typedescr="Personal" version="1" repeatable="true">
		<attributes>
...
INSERT INTO sysconfig (version, item, descr, config) VALUES ('test', 'jpwebform_stepsConfig', 
	'Configurazione steps form', '<?xml version="1.0" encoding="UTF-8"?>
<formtypes>
