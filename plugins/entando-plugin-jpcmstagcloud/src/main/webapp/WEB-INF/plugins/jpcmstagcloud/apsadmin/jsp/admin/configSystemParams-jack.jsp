...
<fieldset class="form-horizontal">
    ...
    <div class="form-group">
        <label for="maxMonthsSinceLastAccess" class="basic-mint-label">
        ...
        <s:else>
            <s:set var="jpcmstagcloud_categoryRootValueVar" value="systemParams.get(#jpcmstagcloud_paramName)"/>
        </s:else>
    ...
    <div class="form-group">
        ...
        <s:else>
            <s:set var="jpcmstagcloud_delayDaysValueVar" value="systemParams.get(#jpcmstagcloud_paramName)"/>
        </s:else>
        <wpsf:textfield useTabindexAutoIncrement="true" name="%{#jpcmstagcloud_paramName}"
                        id="%{#jpcmstagcloud_paramName}" value="%{#jpcmstagcloud_delayDaysValueVar}" cssClass="text"/>
        <wpsf:hidden name="%{#jpcmstagcloud_paramName + externalParamMarker}" value="true"/>
    </div>
</fieldset>