...
<div class="form-group<s:property value="#controlGroupErrorClass" />">
    <label class="col-sm-2 control-label" for="description_lang_<s:property value="#lang.code" />">
    ...
    <s:if test="%{null != #pageMetatagsLangVar}">
        <s:iterator value="#pageMetatagsLangVar" var="pageMetatagVar" status="rowStatus">
            <div class="form-group">
                ...
                <div class="<s:if test="%{#lang.default}" >col-sm-4</s:if><s:else>col-sm-3</s:else>">
                    <wpsf:select 
