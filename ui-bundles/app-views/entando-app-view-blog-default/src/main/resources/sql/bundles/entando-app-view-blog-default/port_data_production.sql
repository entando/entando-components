...
<property key="it">Blog - Riepilogo Categorie</property>
  ...
  <parameter name="contentType">Content Type (mandatory)</parameter>
	<action name="jpblogCategoriesViewerConfig"/>
</config>', 'jpblog', NULL, NULL, 1);
...
INSERT INTO localstrings(keycode, langcode, stringvalue) VALUES ('jpblog_CATEGORIES_TITLE', 'it', 'Tag del Blog');
INSERT INTO localstrings(keycode, langcode, stringvalue) VALUES ('jpblog_CATEGORIES_TITLE', 'en', 'Blog Tags');

INSERT INTO localstrings(keycode, langcode, stringvalue) VALUES ('jpblog_VIEW_ALL', 'it', 'Rimuovi filtro');
INSERT INTO localstrings(keycode, langcode, stringvalue) VALUES ('jpblog_VIEW_ALL', 'en', 'Unfilter');
